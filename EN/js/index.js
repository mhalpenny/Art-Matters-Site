...
function preload() {
  ...
  //layers
  layerA = loadImage('en/assets/box/redLayer.png');
  layerR = loadImage('en/assets/box/blueLayer.png');
  layerM = loadImage('en/assets/box/violetLayer.png');
  layerE = loadImage('en/assets/box/greyLayer.png');
  ...
  iconEx = loadImage('en/assets/gyIcon.png');
  //logo
  amLogo = loadImage('en/assets/amlogo.png');
  //fonts
  font = loadFont('en/fonts/Quicksand-Medium.ttf');
}
...
function setup() {
  ...
  linkC = createA('en/calendar', 'CALENDAR');
  ...
  linkM = createA('en/map', 'MAP');

  linkEx = createA('en/exhibitions', 'EXHIBITIONS');
